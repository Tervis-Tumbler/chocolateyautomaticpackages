...
$packageName= 'SQL Server 2014 with SP2' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'SQL Server 2014 with SP2*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
