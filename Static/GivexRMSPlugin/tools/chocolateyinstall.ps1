...
$packageArgs = @{
  ...
  #unzipLocation = "$toolsDir\GivexRMS_SetUp_1_4_0_261702.exe"
  fileType      = 'EXE' #only one of these: exe, msi, msu
  file         = "$toolsDir\GivexRMS_SetUp_1_4_0_261702.exe"

  softwareName  = 'Givex*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  checksum      = 'F32740A9874B3316EE5612AA64A39F31054335EBA0BF93433AB7E4BD490A8B4B'
