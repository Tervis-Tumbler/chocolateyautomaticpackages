...
$packageName= 'DummyPkg' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://dummy.pkg/' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'DummyPkg*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
